...
until the first one is cut `pyproject.toml` declares the month alone,
which is the shape `RELEASING.md` gives a cycle in progress. The number
will say when a release was cut, and it promises nothing about
